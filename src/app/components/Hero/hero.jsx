...
// 'use client'
// import background from "/landing_page/images/landingbg.JPG";

import Image from 'next/image'

// import Logo from "/landing_page/images/Largo_Hero_Logo.png";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col z-10 ml-16 justify-center h-screen text-[#DFD3BB] ">
          <p className="font-bold text-4xl leading-[97.5px] capitalize tracking-[0.0375em]">
            welcome to
          </p>
          <Image src="/landing_page/images/Largo_Hero_Logo.png" alt="" height={183} width={327}/>
          <p className="mt-14 font-medium text-xl leading-7 tracking-[0.075em] w-96">
            Explore our range of electric bikes and discover the future of
            cycling.
          </p>
          <BrowseProductButton/>
          <div className="w-[501px] border-[1.5px] border-[#FF8811] mt-[34.8px]"></div>
        </div>
      </section>
    </>
  );
