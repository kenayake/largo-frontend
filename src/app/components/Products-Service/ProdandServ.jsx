...
const ProdandServ = () => {
  return (
    <div className="pt-[15vh] px-[5%] md:px-[10%] pb-[10vh] font-normal leading-10 capitalize mt-20 mb-10">
      <p className="mb-4 text-4xl md:text-6xl opacity-50 text-center">Product and Services</p>
      <div className="grid grid-cols-1 md:grid-cols-2 text-center mt-14">
        <div className="text-4xl md:text-7xl px-3">
          Largo E-Bike
        ...
        <div className="text-4xl md:text-6xl mt-3 px-3">
